...
<div class="tg-wrap"><table class="tg">
  ...
  <tr>
    <td class="tg-6k2t"></td>
    <td class="tg-6k2t"><label id="head_chars" >Characters left: </label></td>
  </tr>
  <tr>
  <tr>
...
document.getElementById('chars').innerHTML = "Characters left: " + (400 - content.value.length);
document.getElementById('content').oninput = function () {
document.getElementById('chars').innerHTML = "Characters left: " + (400 - this.value.length);
};
document.getElementById('content').onkeypress = function () {
document.getElementById('chars').innerHTML = "Characters left: " + (400 - this.value.length);
};

document.getElementById('head_chars').innerHTML = "Characters left: " + (70 - content.value.length);
document.getElementById('headline').oninput = function () {
document.getElementById('head_chars').innerHTML = "Characters left: " + (70 - this.value.length);
};
document.getElementById('headline').onkeypress = function () {
document.getElementById('head_chars').innerHTML = "Characters left: " + (70 - this.value.length);
};
