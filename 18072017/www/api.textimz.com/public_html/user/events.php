...
$sql = "SELECT pk_i_id , s_event_name, s_date, s_time, s_venue, s_details, s_link, s_tags FROM t_events ORDER BY pk_i_id DESC LIMIT $first_record , 10";
...
<?php while($res = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
  <tr>
    ...
    <td class="tg-6k2t"><?php echo "<a href = './event.php?id=$event_id'>".$res['s_event_name']."</a>";?></td>
    <td class="tg-6k2t"><?php echo $res['s_time'];?></td>
    <td class="tg-6k2t"><?php echo $res['s_date'];?></td>
    <td class="tg-6k2t"><?php echo $res['s_venue'];?></td>
    <td class="tg-6k2t"><?php echo $res['s_details'];?></td>
    <td class="tg-6k2t"><?php echo $res['s_link'];?></td>
    <td class="tg-6k2t"><?php echo $res['s_tags'];?></td>
...
<?php } ?>
<br /><br />
<a href="./event.php">Add a new Event</a>