	...
	<div class="pure-container" data-effect="pure-effect-reveal">
		...
		<div class="pure-pusher-container">
			<div class="pure-pusher">
				<div class="head">
					<a href="../index.php">
						<div class=" logo_tex"></div></a>


					</div>
					<div class="career-container">
					<div class="career-trans">

						<div class="career-text"> WORK WITH US!</div>
						<div class="career-content">
							We don't have any openings now, but we are GROWING! <br>
							We would love to keep you update, just type in your Email.
						</div>
