            ...
            <div class="pure-pusher-container">
                <div class="pure-pusher">
                    ...
                    <div class = selector_wrapper>
                        ...
                        <div class = slider style="background-image: url(../assets/holidays.png); background-size: cover">
                        </div>
...
function scroll() {
i = i + speed
var div = document.getElementById("ilist")
div.scrollTop = i
if (i > div.scrollHeight - 160) {i = 0}
t1=setTimeout("scroll()",100)
}
</script>
                    <div class = "ilist" id=ilist onload="scroll()">
                        <?php
                            for ($i = 4; $i <= 14; $i++)
                                    {
                                            $id         = $ids[$i];
                        ...
                        <?php
                            ...
                            ?>
<a href="./cards.php?id=<?php echo $slugs[15]; ?>" id ="<?php echo $slugs[15]; ?>"><div style="text-align: right;">more..</div></a>
                    </div>
                    <div class = newsweave_block>
                        <div class = newsweave_head>
                            Get our daily e-letter, Newsweave. <br> Type in your email.
