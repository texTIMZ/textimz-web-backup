                    ...
                    <div class="entry-content">
                        <div class="row-fluid">
                            ...
                            <div class="span8">
                                ...
                                <p class="moretag"><a href="<?php echo $ev_links[$i]; ?>"> Read more</a></p>
                            </div>
...
<div class="pagination magz-pagination" style="background-color: white;"><span class='page-numbers current' ><a   href="<?php if ($sum < $totalIds) {$next= $sum+1; echo "all_events.php?p=$next" ;} if ($sum == $totalIds) { echo '#!';} ?>"><?php if ($sum < $totalIds) { echo "load more";} if ($sum == $totalIds) { echo "No More to load";} ?></a></span>
